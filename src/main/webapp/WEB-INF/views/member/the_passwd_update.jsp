...
<script type="text/javascript">
  ...
  function send() {
    ...
    let url = './the_passwd_check.do?current_passwd=' + current_passwd.value;
...
<c:import url="/menu/top.do" />
  ...
  <form name='frm' id='frm' method='POST' action='./the_passwd_update.do'>
