  ...
  <div class="accordion" id="accordionExample">
    <div class="accordion-item">
      ...
      <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
        <div class="accordion-body" style="white-space:pre-wrap;">${procateVO.explain }</div>
      </div>
    </div>
  ...
  <table class="table table-hover">
    ...
    <tbody>
        <c:forEach var="overcontentsVO" items="${list }" varStatus="info">
          ...
          <tr onclick="location.href='./over_read.do?overcontentsno=${overcontentsno}&word=${param.word }&now_page=${param.now_page == null ? 1 : param.now_page }&catenum=${param.catenum }'" style="cursor: pointer;">
            <td>
              <c:choose>
            ...
            <td class="td_bs_left">
              <span style="font-weight: bold;">${overcontentsVO.title }</span><br>
              <c:choose>
